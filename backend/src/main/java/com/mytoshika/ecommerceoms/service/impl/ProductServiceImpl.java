...
public class ProductServiceImpl implements ProductService {
    ...
    @Cacheable(
            cacheNames = "products",
            key = "#page+'-'+#size+'-'+#sortBy+'-'+#direction+'-'+#keyword+'-'+#minPrice+'-'+#maxPrice+'-'+#category"
    )
    @Override
    ...
    @Caching(
            evict = {@CacheEvict(cacheNames = "product", key = "#id"),
    ...
    public ProductDetailsResponse getProduct(Long id) {
        ...
        return mapToProductDetailsResponse(product,inventory);
    }
    ...
    private ProductDetailsResponse mapToProductDetailsResponse(Product product, Inventory inventory){

        ProductDetailsResponse response = mapper.map(product, ProductDetailsResponse.class);
        response.setAvailableQuantity(inventory.getAvailableQuantity());
